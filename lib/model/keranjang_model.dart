...
class KeranjangModel {
  ...
  static Future<KeranjangModel> aditionalPrice() async {
    await _getToken();


    String apiURL = globalBaseUrl + 'api/checkout/get_rule';
    ...
    try {
      ...
      print('rule cart checkout status code : ' +
          apiResult.statusCode.toString());
