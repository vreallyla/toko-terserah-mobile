...
// import 'package:flutter/services.dart';
>>>>>>> 8efea75320c7e4dd40c56d56ebae3c8bfc52ae7a
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                      hintText: "16 digits only", labelText: "Credit Card"),
                ...
                Row(children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          hintText: "2 digits only", labelText: "Expiry Month"),
                      keyboardType: TextInputType.number,
                      maxLength: 2,
                    ),
                  ),
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          hintText: "4 digits only", labelText: "Expiry Year"),
                      keyboardType: TextInputType.number,
                      maxLength: 4,
                    ),
                  )
                ...
                TextField(
                  controller: _cvvCtrl,
                  decoration: InputDecoration(
                      hintText: "3 digits only", labelText: "CVV"),
                  keyboardType: TextInputType.number,
                  maxLength: 3,
                ),
                TextField(
                  ...
                  decoration: InputDecoration(
                      hintText: "Amount of charge", labelText: "Amount"),
                  keyboardType: TextInputType.number,
                ),
                Padding(
                ...
                FlatButton(
                  ...
                  onPressed: () async {
                    ...
                    // if (_error == "") {
                    //   bool configured = await MidFlutter.configure(clientKey: "SB-Mid-server-UJ5WSnuwe7KPJmK68xew3eD0",isProduction:false);
