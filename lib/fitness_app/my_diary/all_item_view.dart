...
class AllItemView extends StatefulWidget {
  const AllItemView(
  ...
  @override
  _AllItemViewState createState() => _AllItemViewState();
}

class _AllItemViewState extends State<AllItemView>
      ...
      builder: (BuildContext context, Widget child) {
        return FadeTransition(
          ...
          child: Transform(
            ...
            child: Container(
              height: sizeu.width / 3 + (sizeu.width / 3 / 3) + 550,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final int count =
                      mealsListData.length > 10 ? 30 : mealsListData.length;
